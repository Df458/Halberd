...
VLIBS=--pkg=gtk+-3.0 --pkg=$(LIBEDITORTARGET) --pkg=$(LIBGAMETARGET) --pkg=$(COMMONTARGET)
...
EDITORFLAGS=-I$(SRCPATH)$(LIBEDITORTARGET) -I$(SRCPATH)$(LIBGAMETARGET) -I$(SRCPATH)$(COMMONTARGET) -L$(LIBPATH) `$(PKGCONFIG) --cflags gtk+-3.0`
